...
- Create Angular project with ng: `ng new Angular_Products_App.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`Angular_Products_App.client.esproj`).
